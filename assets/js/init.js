...
function elisc_tm_modalbox() {
  ...
  jQuery(".elisc_tm_all_wrap").prepend(
    '<div class="elisc_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><img class="svg" src="assets/img/icons/close.svg" alt="" /></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function elisc_tm_scrollable() {
  ...
  scrollable.each(function () {
    var element = jQuery(this);
    element
      .css({ height: H - avatarHeight - copyright })
      .niceScroll({
        touchbehavior: false,
        cursorwidth: 0,
        autohidemode: true,
